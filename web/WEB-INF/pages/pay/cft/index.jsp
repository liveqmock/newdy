...
<%@ page import="com.cz.pay.cft.util.TenpayUtil" %>
...
<div align="center">
    <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="381" align="left" valign="middle"><a href="https://www.tenpay.com/" target="_blank"><img
                    src="/image/logo.jpg" width="537" height="145" border="0"></a></td>
            ...
            <td align="center" valign="top">
                <table width="760" border="0" cellspacing="0" cellpadding="3" align="center">
                    <tr>
                        ...
                        <td width="743" height="30" bgcolor="#FF6600"><font style="color:#FFFFFF;font-size:14px;"><B>
                            　财付通快速付款通道 方便 快捷 安全</B></font></td>
                    </tr>
                </table>
                ...
                <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <form action="payRequest" method="post" name="directFrm" onSubmit="return payFrm();">
                        <tr>
                            <td align="left">
                                <table width="760" height="30" border="0" align="left" cellpadding="0" cellspacing="1"
                                       bgcolor="#FFCC00">
                                    <tr>
                                        <td align="center" valign="top" bgcolor="#FFFFEE">
                                            <table width="760" height="351" border="0" cellpadding="6" cellspacing="0"
                                                   class="px14">
                                                <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td height="10" align="center" valign="middle"><img
                                                                        src="/image/cft.gif" width="180" height="81">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="24"><font
                                                                        style="color:#000000;font-size:12px;"><B>说明1：</B></font>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="24"><font
                                                                        style="color:#000000;font-size:12px;">本通道为采用财付通付款。请在支付前与本网站达成一致。</font>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="24"><font
                                                                        style="color:#000000;font-size:12px;"><B>说明2：</B></font>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="24"><font
                                                                        style="color:#000000;font-size:12px;">请务必确认好订单和货款后，再付款。可以在快速付款通道里的“付款概要”和“订单金额”中填入相应的订单信息。</font>
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="353" valign="top"><%=spname %>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td valign="top">
                                                        <%=strReq%>
                                                        <input type="hidden" name="order_no" maxlength="50" size="18"
                                                               value="<%=strReq%>"></td>
                                                </tr>
                                                <tr>
                          ...
                          <input name="product_name" type="text" size="18" maxlength="50" value="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top"><input type="text" name="order_price"
                                                                            maxlength="50" size="18"
                           ...
                           <input type="radio" name="trade_mode" value="2">中介担保&nbsp;
                            <input type="radio" name="trade_mode" value="3">后台选择
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top"><textarea name="remarkexplain" cols="48" rows="5"
                                                                               id="remark2"></textarea>
                                                        <br>
                                                        请填写您订单的简要说明（30字以内）
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top"><b>
                                                        <input name="submit" type="image" src="/image/next.gif"
                                                               alt="使用财付通安全支付" width="103" height="27">
                                                    </b></td>
                                                    <td valign="top">&nbsp;</td>
                                                </tr>
                                            </table>
        ...
        <TR>
            <TD>
                <DIV align=left><IMG alt=中国农业银行
                                     src="/image/icon_abc_s.gif" border=0></DIV>
            </TD>
            ...
            <TD>
                <DIV align=left><IMG alt=深圳发展银行
                                     src="/image/icon_sdb_s.gif" border=0></DIV>
            </TD>
...
<TABLE width=760 border=0 align=center cellPadding=0 cellSpacing=0 class="px12">
    ...
    <TR align="center">
        <TD class="txt12 lh15">
            <div align="center"><A href="http://www.tencent.com/"
    ...
    <TR align="center">
        <TD class="txt12 lh15">
            <div align="center"><IMG alt="财付通通过“国际权威安全认证” "
