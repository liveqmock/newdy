...
<style type="text/css">
  #dialog{display: none;z-index: 2;background-color: #fff;}
  #dialog table{margin: 0 auto;font-size: 14px;}
  #dialog table td{color: #868484;height: 38px;line-height: 38px;}
  #dialog table .title{text-align: right;color: #343434;width: 114px;font-weight: bold;}
</style>
...
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.selectui.js"></script>